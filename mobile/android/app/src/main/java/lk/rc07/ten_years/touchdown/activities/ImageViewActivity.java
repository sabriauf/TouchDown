...
public class ImageViewActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private static PlaceholderFragment newInstance(int sectionNumber) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ImageViewAutoHeight imageView = rootView.findViewById(R.id.image);

            if (getArguments() != null)
                Glide.with(this).load(String.format(Locale.getDefault(), FACEBOOK_IMAGE_LINK,
                        imagesList.get(getArguments().getInt(ARG_SECTION_NUMBER)).getId())).placeholder(
                        R.drawable.icon_book_placeholder).into(imageView);
            return rootView;
        }
    }
